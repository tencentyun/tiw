> TODO 注意：本文档SetCallbackKey的接口链接需要修改
...
<table>
    ...
    <tr>
        ...
        <td rowspan="2">
            <a href="https://cloud.tencent.com/document/product/1137/40058" target="_blank">SetTranscodeCallback<br />SetTranscodeCallbackKey</a>
        </td>
         <td>
    ...
    <tr>
        ...
        <td rowspan="4">
            <a href="https://cloud.tencent.com/document/product/1137/40064" target="_blank">SetOnlineRecordCallback<br />SetOnlineRecordCallbackKey</a>
        </td>
        <td>
...
- `CallbackKey`：鉴权密钥，您可以通过互动白板控制台或者调用实时录制(SetOnlineRecordCallbackKey)或者文档转码(SetTranscodeCallbackKey)的API接口设置
...
请求：互动白板发起的事件回调的形式是 HTTP 请求，请求体为 JSON 格式，内容为：

| 参数名称 | 类型 | 描述 |
| -------- | ---- | ---- |
| Timestamp | Integer | 事件生成的 Unix 时间戳，单位秒|
| SdkAppId | Integer | 触发时间的互动白板应用SdkAppId |
