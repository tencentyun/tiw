...
- `CallbackKey`：鉴权密钥，您可以通过[互动白板控制台](https://console.cloud.tencent.com/tiw/app)或者调用实时录制[SetOnlineRecordCallbackKey](https://cloud.tencent.com/document/product/1137/45042)或者文档转码[SetTranscodeCallbackKey](https://cloud.tencent.com/document/product/1137/45041)API接口设置
