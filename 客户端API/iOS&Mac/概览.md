...
| [soundMuteForPPT:](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/soundMuteForPPT:) | 对转码后的H5PPT进行静音  |
| [loadResource:](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/loadResource:) | 课件预加载，提高加载速度，请参考[课件预加载](../../高级功能/课件预加载.md)文档  |
