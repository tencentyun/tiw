...
| API | 描述 |
| --- | --- |
| setAccessibleUsers:operationType: | 设置允许操作哪些用户绘制的图形  |
...
| onTEBAddElement:url:type: | 添加元素回调  |
...
| onTEBTextElementStatusChanged:status:value:left:top: | 文本组件状态回调  |
| onTEBImageElementStatusChanged:url:elementId: | 白板图片元素加载状态  |
| onTEBTextElemenWarning:msg: | 白板图片元素加载状态  |
| onTEBSelectedElements: | 框选工具选中元素回调  |
| onTEBMathGraphEvent:boardId:graphId:message: | 数学函数图像工具事件  |
| onTEBZoomDragStatus:scale:xOffset:yOffset: | 远端白板缩放移动状态回调  |
...
| 类名 | 描述 |
| --- | --- |
| TEduBoardUserInfo | 白板信息  |
| TEduBoardInfo | 白板信息  |
| TEduBoardFileInfo | 文件信息  |
| TEduBoardElementInfo | 元素信息  |
| TEduBoardAuthParam | 授权参数  |
| TEduBoardInitConfig | 白板初始化常规配置参数  |
| TEduBoardInitUserConfig | 用户配置参数  |
| TEduBoardInitStyleConfig | 样式配置参数  |
| TEduBoardElementOperationAuthority | 白板元素操作权限  |
| TEduBoardOperationAuthority | 白板操作权限  |
| TEduBoardInitAuthConfig | 权限配置参数  |
| TEduBoardInitParam | 白板初始化参数  |
| TEduBoardLineStyle | 直线样式  |
| TEduBoardTranscodeConfig | 文件转码参数  |
| TEduBoardTranscodeFileResult | 文件转码结果  |
| TEduBoardAddElementOptions | 鼠标样式  |
| TEduBoardCursorIcon | 鼠标样式  |
| TEduBoardSnapshotInfo | 快照信息  |
| TEduBoardToolTypeTitleStyle | 工具提示语样式  |
| TEduBoardElementMathBoard | 数学函数画板  |
| TEduBoardElementMathGraph | 数学函数图像  |
...
| TEduBoardAccessibleOperation | 位置类型  |
