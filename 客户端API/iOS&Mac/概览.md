...
| API | 描述 |
| --- | --- |
| [enableCache](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/enableCache) | 获取缓存的启用状态  |
| [getVersion](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/getVersion) | 获取版本号  |
| [isSingleMode](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/isSingleMode) | 获取单实例模式  |
| [setEnableCache](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/setEnableCache) | 启用和关闭缓存, 请在TEduBoardController初始化之前调用  |
| [setSingleMode](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/setSingleMode) | 是否开启单实例模式  |
...
| [setOwnerNickNameVisible](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/setOwnerNickNameVisible:) | 是否本地显示自己的别名 |
| [useMathTool](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/useMathTool:) | 使用数学教具 |
| [getElementById](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/getElementById:) | 获取白板中的元素信息 |
| [updateElement](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/updateElement:type:value:) | 设置元素样式 |
...
| [getPPTRemarks](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/getPPTRemarks:pageIndex:) | 获取PPT的备注 |
...
| [enablePenAutoFit](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/enablePenAutoFit:delay:) | 开启绘制涂鸦过程中自动拟合图形（魔法笔）  |
| [setHighlighterColor](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/setHighlighterColor:) | 设置荧光笔颜色  |
| [getHighlighterColor](https://doc.qcloudtiw.com/ios/Classes/TEduBoardController.html#//api/name/getHighlighterColor) | 获取荧光笔颜色  |
