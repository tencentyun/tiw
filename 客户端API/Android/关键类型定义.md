...
> 由 TEduBoardController.TEduBoardCallback.onTEBError 触发，出现此错误表示白板已经不可用<br/>白板错误码[TEduBoardErrorCode](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardErrorCode.html)
...
| TEDU_BOARD_ERROR_TIM_INVALID | int | 5 |互动白板内置IMSDK不可用 互动白板内部会反射调用IMSDK接口，如果IMSDK升级了后则会调用失败，此时需要在初始化禁用内置，初始化参数timsync设置为false，然后再单独接入IMSDK， |具| 体请参考文档。 |
| TEDU_BOARD_ERROR_HISTORYDATA | int | 6 |同步历史数据失败，监听到此错误，建议进行重试 |
| TEDU_BOARD_ERROR_RUNTIME | int | 7 |白板运行错误 |
| TEDU_BOARD_ERROR_AUTH_TIMEOUT | int | 8 |服务鉴权超时，可以存在网络问题，请重试 |
| TEDU_BOARD_ERROR_DATA_TOO_LARGE | int | 9 |addImagesFile传输的数据太大，请分拆成两个或多个传递（例如，添加图片组文件时 url 数量太大） |
...
> 由 TEduBoardController.TEduBoardCallback.onTEBWarning 事件触发，警告级别，不会影响白板使用<br/>白板警告码[TEduBoardWarningCode](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardWarningCode.html)
...
| TEDU_BOARD_WARNING_H5PPT_ALREADY_EXISTS | int | 3 | 调用addTranscodeFile接口时候传入的课件已经存在 |
| TEDU_BOARD_WARNING_ILLEGAL_OPERATION | int | 5 | 互动白板历史数据加载完成回调（onTEBHistroyDataSyncCompleted）之前禁止调用接口进行操作白板 |
| TEDU_BOARD_WARNING_H5FILE_ALREADY_EXISTS | int | 6  | 调用addH5File接口传入的h5 url已经存在 |
| TEDU_BOARD_WARNING_VIDEO_ALREADY_EXISTS | int | 7 | 调用addVideoFile接口传入的video url已经存在 |
| TEDU_BOARD_WARNING_IMAGESFILE_ALREADY_EXISTS | int | 8 | 调用addImagesFile接口传入的图片数组数据已经存在 |


### TEduBoardController.TEduBoardAccessibleOperation

> [互动白板可操作权限](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardAccessibleOperation.html)
...
> [箭头类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardArrowType.html)
...
> [音频文件状态](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardAudioStatus.html)
...
> [H5 背景状态](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardBackgroundH5Status.html)
...
> [白板背景类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardBackgroundType.html)
...
> [白板内容自适应模式](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardContentFitMode.html)
...
> [元素类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardElementType.html)
...
> [白板可擦除元素类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardErasableElementType.html)
...
> [文件转码状态](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardFileTranscodeStatus.html)
...
> [H5 文件状态](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardH5FileStatus.html)
...
> [H5PPT加载状态](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardH5PPTStatus.html)
...
| TEDU_BOARD_H5_PPT_STATUS_CANCEL | int	| 3 | 取消加载（当前ppt还没有加载完成，则切换到了其他文件） |
...
> [白板图片填充对齐模式](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardImageFitMode.html)
...
> [白板图片加载状态](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardImageStatus.html)
...
> [工具直线类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardLineType.html)
...
> [数学函数图像工具状态码](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardMathGraphCode.html)
...
> [数学图形类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardMathGraphType.html)
...
> [椭圆绘制模式](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardOvalDrawMode.html)
...
> [画笔拟合类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardPenFittingMode.html)
...
> [显示位置常量](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardPosition.html)
...
> [服务类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardServiceType.html)
...
| PPT_THUMBNAIL | java.lang.String | PPT_THUMBNAIL | ppt缩略图 |
...
> [白板文字工具异常状态码](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardTextComponentStatus.html)
...
> [白板文本样式](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardTextStyle.html)
...
> [白板工具类型](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardToolType.html)


| 枚举 | 类型 | 值 | 描述 |
| --- | --- | --- | --- |
| TEDU_BOARD_TOOL_TYPE_MOUSE | int | 0 | 鼠标，默认鼠标工具点击白板会进行翻页，如果不需要此功能，可以调用setMouseToolBehavior接口设置，也可以通过初始化参数设置 |
...
| TEDU_BOARD_TOOL_TYPE_ZOOM_DRAG | int | 12 | 缩放和移动工具，从2.6.4点版本起，支持初始化传入pinchToZoomEnable开启在任意工具下进行缩放白板 |
...
> [白板上传状态](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardUploadStatus.html)
...
> [视频文件状态](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardVideoStatus.html)
...
> [元素对象](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.ElementItem.html)


| 枚举 | 类型 | 值 | 描述 |
| --- | --- | --- | --- |
| elementId | java.lang.String | - | 元素ID |
| type | int | - | 元素类型 |

### TEduBoardController.ElementOperationAuthority

> [单个元素具有的操作权限](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.ElementOperationAuthority.html)


| 枚举 | 类型 | 值 | 描述 |
| --- | --- | --- | --- |
| disableArbitraryScale | boolean | - | 是否禁用任意缩放 (文本元素默认为true,不可更改) |
| disableMove | boolean | - | 是否禁用移动  |
| disableProportionScale | boolean | - | 是否禁用等比例缩放  |
| disableRotate | boolean | - | 是否禁用旋转 (文本元素默认为true,不可更改) |

### TEduBoardController.MouseToolBehavior

> [鼠标工具行为](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.MouseToolBehavior.html)


| 枚举 | 类型 | 值 | 描述 |
| --- | --- | --- | --- |
| h5PPT | boolean | - | 设置鼠标工具在动态ppt转码的文件翻页行为, 默认为true |
| imgFile | boolean | - | 设置鼠标工具在图片文件（addImagesFile接口添加的文件）翻页行为, 默认为true |
| imgPPT | boolean | - | 设置鼠标工具在静态ppt转码文件翻页行为, 默认为true |
| whiteBoard | boolean | - | 设置鼠标工具在普通白板翻页行为, 默认为true |

### TEduBoardController.OperationAuthority

> [白板元素操作权限](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.OperationAuthority.html)
...
> [互动白板初始化授权参数](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardAuthParam.html)
...
> [颜色参数](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardColor.html)
...
> [鼠标样式](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardCursorIcon.html)
...
> [白板元素信息](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardElementInfo.html)

| 枚举 | 类型 | 值 | 描述 |
| --- | --- | --- | --- |
| boardId | java.lang.String | - | 白板ID |
| elementId | java.lang.String | - | 元素ID |
...
> [文件信息](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardFileInfo.html)
...
> [数学函数信息](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardFunctionGrapher.html)

| 枚举 | 类型 | 值 | 描述 |
| --- | --- | --- | --- |
| color |java.lang.String | - | 数学函数图像颜色 |
| expression |java.lang.String | - | 数学函数表达式 |
| mathBoardId |java.lang.String | - | 函数画板的元素id |
| selectedColor |java.lang.String | - | 数学函数图像选中时的颜色 |
### TEduBoardController.TEduBoardInfo

> [白板信息](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardInfo.html)
...
> [白板初始化参数](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardInitParam.html)
...
| enableScaleTool | boolean | - | 是否启用白板缩放移动工具的缩放功能，当设置为false，切换到缩放移动工具时缩放功能不可用。 |
...
> [直线样式](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardLineStyle.html)
...
> [函数画板参数](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardMathCanvas.html)
...
> [快照信息](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardSnapshotInfo.html)
...
> [工具标题样式](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardToolTypeTitleStyle.html)
...
> [文件转码参数](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardTranscodeConfig.html)
...
> [文件转码结果](http://doc-1259648581.cos.ap-chongqing.myqcloud.com/android/com/tencent/teduboard/TEduBoardController.TEduBoardTranscodeFileResult.html)
