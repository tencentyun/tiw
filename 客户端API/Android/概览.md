...
| onTEBSelectElement | 框选工具选中元素回调  |
| onTEBMathGraphEvent | 数学函数图像工具事件  |
| onTEBZoomDragStatus | 远端白板缩放移动状态回调  |
| onTEBBackgroundH5StatusChanged | 设置白板背景 H5 状态改变回调  |
| onTEBTextElementWarning | 白板文字工具异常警告  |
| onTEBImageElementStatusChanged | 白板图片元素加载状态  |
...
| onTEBSnapshot | 白板快照  |
| onTEBH5PPTStatusChanged | ppt状态改变回调  |
| onTEBTextElementStatusChange | 文本组件状态回调  |
