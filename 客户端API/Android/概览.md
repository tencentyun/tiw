...
| [setRemoteCursorVisible](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#setRemoteCursorVisible-boolean-) | 设置远端画笔在本地是否显示 |
...
| API | 描述 |
| --- | --- |
| [addImagesFile](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#addImagesFile-java.util.List-) | 批量导入图片<br/>当传入文件的 URL 重复时，返回 URL 对应的 文件 ID<br/>最大支持5k的数据  |
| [applyFileTranscode](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#applyFileTranscode-java.lang.String-com.tencent.teduboard.TEduBoardController.TEduBoardTranscodeConfig-) | 发起文件转码请求  |
| [getFileTranscodeProgress](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#getFileTranscodeProgress-java.lang.String-) | 主动查询文件转码进度<br/>该接口仅用于特殊业务场景下主动查询文件转码进度，调用 applyFileTranscode 后，SDK 内部将会自动定期触发 onTEBFileTranscodeProgress 回调，正常情况下您不需要主动调用此接口 |
...
| [addImageElement](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#addImageElement-java.lang.String-) | 添加图片资源(已废弃，请使用addElement接口代替)  |
...
| [addH5File](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#addH5File-java.lang.String-) | 添加 H5 页面  |
...
| [addVideoFile](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#addVideoFile-java.lang.String-) | 添加视频文件  |
...
| [addSnapshotMark](https://doc.qcloudtiw.com/android/com/tencent/teduboard/TEduBoardController.html#addSnapshotMark--) | 生成板书图片标记<br/>需要配合服务端API接口来生成，服务端会根据标记点进行快照截图  |